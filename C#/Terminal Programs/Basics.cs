...
// there also exists decimal variable type, even larger float/double (16 byte)

class Askisi1 {	
	public static void Main(string[] args) { // "string[] args" is optional
		int a = 15;
		int b = 23;
